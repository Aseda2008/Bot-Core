      ...
      <div className="container">
        <div className="Details">
          ...
          <div class="Details--right">
           ...
           <div class="Details--right__star">
            ...
            <div class="Details--right__Quantity">
                <h2>Quantity :</h2>
                <h3> <p onClick={() => setCount(count === 1 ? 1 : count - 1)}>-</p>{count} <p onClick={() => setCount(count + 1)}>+</p></h3>
                <button>Add To Cart<IoArrowForwardCircle /></button>
            </div>
          </div>
        </div>
          ...
          borderRadius:" 10px",
            ...
            <p>Welcome to the world of natural and organic. Here you can discover the bounty of nature. <br/>
             We have grown on the principles of health, ecology, and care. We aim to give our customers a healthy <br/>
             chemical-free meal for perfect nutrition. It offers about 8–10% carbs. Simple sugars — such as glucose and <br/>
             fructose — make up 70% and 80% of the carbs in raw.</p>
          </div>
      </div>
    </div>
  );
